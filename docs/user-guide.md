...
* [Working with molecular geometry](Guide-geometry): a more in depth dive into the structure of the `MolecularGeometry` class and its use.
...
* [Cheminformatics](Guide-cheminformatics): how to extend the functionality of the `System` class to analyze connectivity, access cheminformatic descriptors and tools.
